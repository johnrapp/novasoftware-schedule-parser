...
\begin{document}
	...
	\begin{eqnarray}
		P' &=& (s_x \cdot x + t_x, s_y \cdot y + t_y)\nonumber\\
		\implies x' &=& s_x \cdot x + t_x, \nonumber\\
		y' &=& s_y \cdot y + t_y \nonumber
	\end{eqnarray}
