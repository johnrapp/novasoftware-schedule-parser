...
\begin{document}
	...
	\renewcommand{\bibpreamble}{
		\textit{All sources were reviewed at the date of publication of this paper. Because the information stated in the theory section of this paper (which is were the sources are referred from) is recognized as basic knowledge in the field, Wikipedia is considered a reliable source.}
	}
	\todo{
		Behövs inte källor, Wikipedia är bara referens
		typ av arete som inte gått ut på källforskning 	
	}
